...
def preprocess_openings(data_str):
    fen_to_best_move = {}
...
class ChessBot(ChessBotClass):
    def __init__(self, depth=4, time_limit=10):
        ...
        self.fen_to_best_move = preprocess_openings(openinigs)
...
openinigs = """Nf3 d5 d4 Nf6 c4 dxc4 e3 e6 Bxc4 c5 O-O a6 dxc5 Qxd1 Rxd1 Bxc5 a3 | Score: -24
